...
export const whatsappNumber = "5551996707462"

export default function Contact() {

  const instagramUser = "barbearia_boemia01" 
  const address = "Av. Minas Gerais, 1892 - sala 4 - Tramandaí, RS"
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="ml-6">
                  ...
                  <p className="text-xl font-bold group-hover:text-primary transition-colors">(51) 99670-7462</p>
                </div>
              </a>
          ...
          <div className="w-full lg:w-1/2 h-[450px] relative group">
            ...
            <div className="relative z-10 w-full h-full bg-zinc-900 overflow-hidden rounded-sm grayscale contrast-[0.9] hover:grayscale-0 transition-all duration-700">
               <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d110575.99043334172!2d-50.28892845664065!3d-29.993804899999986!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95180d0ddaa6e65d%3A0x4fb92daa69b26244!2sBarbearia%20bo%C3%AAmia!5e0!3m2!1spt-BR!2sbr!4v1770702230287!5m2!1spt-BR!2sbr" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
